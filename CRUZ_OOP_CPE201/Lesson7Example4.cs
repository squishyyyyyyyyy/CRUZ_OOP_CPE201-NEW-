...
namespace CRUZ_OOP_CPE201
{
        ...
        
    {
        ...
        private void other_nohourstxt_Leave(object sender, EventArgs e)
        {
            try
            {
        ...
        private void hono_nohourstxt_Leave(object sender, EventArgs e)
        {
            try
            {
        ...
        private void basic_nohourstxt_Leave(object sender, EventArgs e)
        {
            try
            {
