...
{
    public partial class Lesson3Example3_Function : Form
    {
        private double total_amount = 0;
        private int total_qty = 0;
        public Lesson3Example3_Function()
        {
            InitializeComponent();
        }
        private void item_priceValue(string discount_amount, string price)
        {
            discntamttxtbox.Text = discount_amount;
        ...
        private void Lesson3Example3_Function_Load(object sender, EventArgs e)
        {
            // Disable textboxes
        ...
        {
            Lesson3Example3PrintForm_Function print = new Lesson3Example3PrintForm_Function();
